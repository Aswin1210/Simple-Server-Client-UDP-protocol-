...
def ExtractData(packet):                                            #Extracts the packet
    ...
    pktFrmt="!BH"+str(dataLen)+"s"                                  #This is the packet format. example if data length is 1021 bytes then it should be "!BH1021s".
...
def MakePkt(seqNums,chksums,data):
    pktFrmt="!BH"+str(len(data))+"s"                                #This is the packet format. example if data length is 1021 bytes then it should be "!BH1021s".
